	  ...
	  protected ExtentReportsUtility extentReportUtility=ExtentReportsUtility.getInstance();
		...
		public WebElement findElement(By by) {
	        try {
	            ...
	            mylog.info("Element found: " + by.toString());
	            return element;
	        } catch (Exception e) {
	            mylog.error("Failed to find element: " + by.toString() + " - " + e.getMessage());
	            return null;
	        }
	    }
		 ...
		 public void maximizeWindow() {
		        try {
		            ...
		            mylog.info("Window maximized successfully.");
		        } catch (Exception e) {
		            mylog.error("Failed to maximize window: " + e.getMessage());
		        }
		    }
		...
		// Method to find multiple elements
		 ...
		 // Method to open a new window
		    ...
		    public void sendKeys(WebElement ele,String data,String objectName) {
		...
		public void enterText(WebElement ele,  String objectName) {
	        if (ele.isDisplayed()) {
	            ele.clear();
	            mylog.info("Data entered in the " + objectName);
	        } else {
